...
export function inferensi(
  ...
  const rules = [
    ...
    { ips: 'rendah', ipk: 'tinggi', mk: 'banyak',  output: 'tinggi' },
    ...
    { ips: 'tinggi', ipk: 'tinggi', mk: 'banyak',  output: 'sedang' },
