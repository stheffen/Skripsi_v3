              ...
              <>
                ...
                <div className="bg-slate-800/50 border border-slate-800 p-4 rounded-2xl flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-slate-200">{(user as any).angkatan || '-'}</p>
                  </div>
                </div>
                ...
                <div className="bg-slate-800/50 border border-slate-800 p-4 rounded-2xl flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-slate-200">Semester {user.semester_aktif || '-'}</p>
                  </div>
                </div>
              </>
            )}
