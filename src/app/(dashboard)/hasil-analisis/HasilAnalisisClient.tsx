              ...
              <div className="text-center py-2 relative">
                <svg viewBox="0 0 200 120" className="w-48 mx-auto drop-shadow-lg">
                  ...
                  <path d="M 20 100 A 80 80 0 0 1 180 100" fill="none"
                    stroke={result.kategori === 'Tinggi' ? '#ef4444' : result.kategori === 'Sedang' ? '#f59e0b' : '#10b981'}
                    strokeWidth="18" strokeLinecap="round"
                    strokeDasharray="251.3"
                    strokeDashoffset={251.3 - (result.fuzzy_output / 100) * 251.3} />
                  <text x="100" y="85" textAnchor="middle" fontSize="24" fontWeight="bold"
                    fill={result.kategori === 'Tinggi' ? '#ef4444' : result.kategori === 'Sedang' ? '#f59e0b' : '#10b981'}>
                    {result.fuzzy_output?.toFixed(1)}
                  </text>
